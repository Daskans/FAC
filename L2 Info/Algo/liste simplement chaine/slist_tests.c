...
main (void)
{
  ...
  printf ("\nCheck slist_concat()\n"
          "======================\n");
  EXPECT ((slist_concat (list, copy) == list),
          "slist_concat (list, copy) == list");
  EXPECT ((slist_length (list) == 2 * LIST_LENGTH),
          "slist_length (list) == %u", 2 * LIST_LENGTH);

  printf ("\nCheck slist_insert_at()\n"
          "======================\n");
  EXPECT ((slist_insert_at (list, 10, 88) == list),
          "slist_insert_at (list, 10, 88) == list");
  EXPECT ((slist_length (list) == 2 * LIST_LENGTH + 1),
          "slist_length (list) == %u", 2 * LIST_LENGTH + 1);
