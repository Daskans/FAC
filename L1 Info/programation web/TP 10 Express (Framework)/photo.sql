...
<<<<<<< HEAD:L1 Info/Prog web/TP 8 SQL algebre relationnelle/sujet/photo.sql
--SELECT * FROM photographes;
=======
SELECT * FROM photographes;
>>>>>>> b084d19787e4bf87e3ff423f6f2bede3f77c8533:L1 Info/programation web/TP 10 Express (Framework)/photo.sql
